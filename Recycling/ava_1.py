...
# Plot Data
def plotData(self,x1,y1,x2,y2,title1,title2):
    # Clear subplots
    self.subplot.cla()
    self.subplot.cla()

    # plot new data to the same axes
    self.subplot1.plot(x1,y1,"-o")
    self.subplot1.title(title1)
    self.subplot2.plot(x2,y2,"-o")
    self.subplot2.title(title2)
...
class AVA(tk.Tk):
    ...
    def __init__(self, *args,**kwargs):
        ...
        for F in (StartPage, DataCollectPage, PlotPage, ProfilePage, ListboxSelectPage):
...
class ListboxSelectPage(tk.Frame):
...
class PlotPage(tk.Frame):
    ...
    def button1Click(self, event):
        ...
        x1,y1 = FFT_Library.OptimizeFFT (data1)
        x2,y2 = FFT_Library.OptimizeFFT (data2)
